...
//!
//! These helpers are internal to the storage package. Keeping them here lets
//! `storage.rs` remain the public persistence facade while migrations and
//! state mapping share the small amount of database compatibility code they
//! genuinely need.
...
pub(super) const RECENT_RECEIPT_LIMIT: usize = 100;

pub(super) fn catalogue_model_for_persisted_id(model_id: &str) -> Option<&'static TrainModel> {
...
pub(super) fn catalogue_model_for_legacy_signature(
    model_name: &str,
...
pub(super) const V16_IDENTITY_TABLES_COMPAT_SCHEMA: &str = r#"
...
pub(super) fn optional_row_domain_id<T>(
    row: &rusqlite::Row<'_>,
    index: usize,
    field: &'static str,
...
pub(super) fn conversion_error(index: usize, field: &'static str) -> rusqlite::Error {
    rusqlite::Error::FromSqlConversionFailure(
        index,
...
pub(super) fn from_db_u64(value: i64, field: &'static str) -> Result<u64, &'static str> {
...
pub(super) fn invalid_value(path: &Path, field: &'static str) -> SaveSlotError {
