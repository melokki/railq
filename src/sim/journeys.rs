...
pub fn dispatch_journey(
    ...
    let quote =
        quote_journey_at(state, train_id, service_id, departed_at).map_err(DispatchError::Quote)?;
    ...
    state.active_journeys.push(Journey {
        ...
        fare_rate: state.rules.balance.fare_per_passenger_kilometre(),
        fare: quote.fare,
...
pub fn dispatch_positioning_journey(
    ...
    let quote = quote_positioning_journey_at(
        state,
        train_id,
        service_id,
        destination_station_id,
