...
use crate::{
    ...
    model::{
        GameState, Money, RailStationId, ServiceId, TrainId,
    },
    sim::{
...
mod chrome;
use chrome::{
    HELP_PAGE_STEP, help_lines, render_footer, render_help_overlay, shell_status_line, tab_label,
};
mod overlays;
use overlays::{
    ActionOutcome, bankruptcy_text, render_bankruptcy_restart_confirmation,
