...
use journeys::{render_compact_journey_board, render_journey_inspector, render_journey_workspace};
...
mod tests {
    ...
    use super::{
        MapDirection, MapWorkspace, MapWorkspaceAction, TERMINAL_CELL_HEIGHT_TO_WIDTH,
        WorldDetailsKeyAction, directional_line_length, focus_rank, journey_progress_percent,
